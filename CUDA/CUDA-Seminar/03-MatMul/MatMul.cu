//headers
#include <stdio.h>
#include <cuda.h>           //cuda standard header file
...
int main(int argc, char *argv[])
{
    ...
    void matMulHost(float *A, float *B, float *C, int numAColumns, int numCRows, int numCColumns);
    void cleanup();
    ...
    if(bAccuracy == true)
        ...
        sprintf(str, "%s", "Not All Comparison Of Output Arrays On CPU And GPU Are Accurately Within The Limit of 0.000001");
    ...
    printf("Grid Dimension = (%d, 1, 1) And Block Dimension = (%d, %d, 1)\n", DimGrid.x, DimBlock.x, DimBlock.y);
